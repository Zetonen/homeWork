...
function rightLeft(x1, y1, x2, y2) {
    if (x1 == x2 && y1 == y2) {
        return true
    } else if (y1 == y2) {
        if (x1 < x2 && x1 < 8) {
...
if (leftDown(x1, y1, x2, y2) || rightDown(x1, y1, x2, y2) || rightUp(x1, y1, x2, y2) || leftUp(x1, y1, x2, y2) || rightLeft(x1, y1, x2, y2) || upDown(x1, y1, x2, y2)) {
    alert("True")
} else {
    alert("False")
}